        ...
        <section className='bg-[#e84c3d] py-16 text-white'>
            <div className=' container mx-auto px-4'>
                <div className='border-b border-white/20 pb-8'>
                    ...
                    <footer className='grid grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 mt-5'>
                        <div>
                            <h3 className='text-2xl font-semibold mb-2'>Pet Shop Dev</h3>
                            <p className='mb-4'>Cuidando do seu melhor amigo com amor</p>
                            <a target='_blank' href="{`https://wa.me/556799998800?text=Olá vim pelo site e gostaria de mais informações`}"
