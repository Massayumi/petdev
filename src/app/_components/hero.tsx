                ...
                <article className='grid grid-cols-1 lg:grid-cols-2 gap-8 '>
                    <div className='space-y-6'>
                        ...
                        <p className="lg: text-lg">
                            Oferecemos os emlhores serviçpes para garantir o bem-estar e a feclidade do seu amigo de quatro patas
                        </p>
                    ...
                    <div className='hidden md:block h-full relative'>
                        <Image
                        src={dogImg} alt='foto de um cachorro' className='object-contain' fill sizes='(max-width: 768px) 0px 50vh' quality={100} priority/>
                    </div>
                </article>
            </div>
        </section>
